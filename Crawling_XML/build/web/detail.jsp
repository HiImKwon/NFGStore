                    ...
                    <button type="submit"><i class="fas fa-search"></i></button> -->
                        ...
                        <c:if test="${not empty product}">
                            <script>
                                ...
                                var avaUrl = productXMLString.getElementsByTagName("avaUrl")[0].childNodes[0];
                                var href = productXMLString.getElementsByTagName("href")[0].childNodes[0];
                                var cheapestPrice = productXMLString.getElementsByTagName("cheapestPrice")[0].childNodes[0];
